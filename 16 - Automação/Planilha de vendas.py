"""
Problem Statement:
Usando a biblioteca openpyxl (pip install openpyxl), leia o arquivo ../Arquivos/vendas.csv
...
Path(__file__).parent.parent / "Arquivos" / "vendas.csv"
...
Examples:
Output (com o vendas.csv da pasta Arquivos):
